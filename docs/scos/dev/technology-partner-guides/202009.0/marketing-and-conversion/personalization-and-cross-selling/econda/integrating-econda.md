...
Details on how to work with Javascript and templates in Spryker can be found in the [Front-End guide](https://docs.spryker.com/docs/scos/dev/front-end-development/yves/atomic-frontend/atomic-front-end-general-overview.html).
