...
For information on how to protect resources, refer to [Security and Authentication](https://docs.spryker.com/docs/scos/dev/setup/installing-spryker-with-development-virtual-machine/devvm-system-requirements.html).
