...
To integrate Billpay make sure you familiar with concept of [Extending Spryker](https://docs.spryker.com/docs/scos/dev/back-end-development/extending-spryker/development-strategies/spryker-os-module-customisation/extending-the-spryker-core-functionality.html).
