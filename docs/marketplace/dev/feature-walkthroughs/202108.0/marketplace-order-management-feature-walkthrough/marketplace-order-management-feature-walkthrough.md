...
The orders are designed to be used by the Marketplace operator, while the merchant orders are always connected to a merchant. To learn more about the core Marketplace objects, see [Marketplace domain model](https://docs.spryker.com/docs/marketplace/dev/architecture-overview/marketplace-domain-model.html).
