...
For details about how to use and configure Redis as a key-value storage, see [Using and configuring Redis as a key-value storage](https://docs.spryker.com/docs/scos/dev/back-end-development/client/using-and-configuring-redis-as-a-key-value-storage.html).
...
For details about how to use Client, use `Client` of the `MerchantProductOfferStorage` module for getting the cached data, see [Client](https://docs.spryker.com/docs/scos/dev/back-end-development/client/client.html).
